...
public class SSOUtils {
    ...
    public static String SERVER_SSM_TEST;    //当前客户端地址 http://localhost:8802/sso_test/ 在sso.properties配置
    ...
    static {
        ...
        SERVER_SSM_TEST = ssoProperties.getProperty("server-ssm-test");
    }
    ...
    public static String getRedirectUrl(HttpServletRequest request){
        //获取请求URL
        return SERVER_SSM_TEST + request.getServletPath();
    }
